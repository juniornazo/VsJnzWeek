	...
	public function new(_strumTime:Float, _noteData:Int, ?_editor = false, ?_prevNote:Note, ?_sustainNote:Bool = false)
	{
		...
		switch (daStage)
		{
			...
			default:
				...
				frames = FlxAtlasFrames.fromSparrow('assets/images/street/MadBunnyNOTE_assets.png', 'assets/images/street/MadBunnyNOTE_assets.xml');
		...
		if (isSustainNote && prevNote != null)
		{
			...
			if (PlayState.curStage.startsWith('MadStreet'))
				x += 10;
