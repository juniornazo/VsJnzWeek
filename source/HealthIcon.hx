...
class HealthIcon extends FlxSprite
{
	...
	public function new(char:String = 'face', isPlayer:Bool = false, ?_id:Int = -1)
	{
		...
		if(Config.betterIcons){
			...
			animation.add('jnz', [24, 25, 26], 0, false, isPlayer);
			animation.add('mad-bunny', [27, 28, 29], 0, false, isPlayer);
			animation.add('bf-christmas', [0, 1, 30], 0, false, isPlayer);
			animation.add('bf-pixel', [21, 41, 40], 0, false, isPlayer);
			animation.add('bf-alpha', [53, 54, 55], 0, false, isPlayer);
			...
			animation.add('gf-street', [16, 49, (_id != -1) ? 49 : 35], 0, false, isPlayer);
			...
			animation.add('bf-alpha', [53, 54], 0, false, isPlayer);
			animation.add('jnz', [24, 25], 0, false, isPlayer);
			animation.add('mad-bunny', [27, 28], 0, false, isPlayer);
			...
			animation.add('gf-street', [16], 0, false, isPlayer);
