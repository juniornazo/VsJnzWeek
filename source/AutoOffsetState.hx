...
class AutoOffsetState extends MusicBeatState
{
	...
	function exit():Void {
		...
		ending = true;
		Config.write(offsetCalc, Config.accuracy, Config.portuguese, Config.healthMultiplier, Config.healthDrainMultiplier, Config.betterIcons, Config.downscroll, Config.noteGlow, Config.ghostTapType, Config.noFpsCap, Config.controllerScheme);
