...
class Startup extends MusicBeatState
{
    ...
    var songs:Array<String> =   ["Tutorial", 
                                ...
                                "Senpai", "Roses", "Thorns", "Shine-Stars", "Fasting-Time", "Mad-Buns"];
    ...
    var characters:Array<String> =   ["BOYFRIEND", "bfCar", "christmas/bfChristmas", "weeb/bfPixel", "weeb/bfPixelsDEAD",
                                    "GF_assets", "gfCar", "christmas/gfChristmas", "weeb/gfPixel", "JuniorNazo_Assets", "street/GF_street",
                                    "DADDY_DEAREST", "spooky_kids_assets", "Monster_Assets",
                                    "Pico_FNF_assetss", "Mom_Assets", "momCar", "MadBunny",
                                    "christmas/mom_dad_christmas_assets", "christmas/monsterChristmas", "street/BfDead",
    ...
    var graphics:Array<String> =    ["logoBumpin", "titleBG", "gfDanceTitle", "titleEnter",
                                    ...
                                    "weeb/weebSky", "weeb/weebSchool", "weeb/weebStreet", "weeb/weebTreesBack", "weeb/weebTrees", "weeb/petals", "weeb/bgFreaks", "street/friends", "street/streetcity_bg", "street/madbuns_street",
