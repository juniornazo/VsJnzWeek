...
class MenuItem extends FlxSpriteGroup
{
	...
	public function new(x:Float, y:Float, weekNum:Int = 0)
	{
		...
		week.animation.addByPrefix('week7', 'WeekJnz', 24);
		week.animation.addByPrefix('week8', 'tutorial selected', 24);
		week.animation.addByPrefix('week9', "WEEK1 select", 24);
		week.animation.addByPrefix('week10', "week2 select", 24);
		week.animation.addByPrefix('week11', "Week 3 press", 24);
		week.animation.addByPrefix('week12', "Week 4 press", 24);
		week.animation.addByPrefix('week13', "week 5", 24);
		week.animation.addByPrefix('week14', "Week 6", 24);
		week.animation.addByPrefix('week15', 'WeekJnz', 24);
		add(week);
