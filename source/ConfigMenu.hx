...
class ConfigMenu extends MusicBeatState
{
	...
	var settingDesc:Array<String> = [
									...
									"Ative isso para deixar os dialogos em portugues[So funciona na week jnz]", 
	...
	{	
		...
		portugueseValue = Config.portuguese;
				...
				switch(configSelected){
					case 0: //Offset
						...
						if(FlxG.keys.justPressed.ENTER){
							...
							Config.write(offsetValue, accuracyType, portugueseValue, healthValue / 10.0, healthDrainValue / 10.0, iconValue, downValue, glowValue, randomTapValue, noCapValue, scheme);
					...
					case 2: //Portuguese
						if (controls.RIGHT_P || controls.LEFT_P || controls.ACCEPT) {
							FlxG.sound.play('assets/sounds/scrollMenu' + TitleState.soundExt);
							portugueseValue = !portugueseValue;
						}
					case 4: //Random Tap 
						if (controls.RIGHT_P)
							{
	...
	function getSetting(r:Int):Dynamic{
		...
		switch(r){
			...
			case 2: return portugueseValue;
			case 3: return noCapValue;
	...
	function secretPresetTest(_combo:Array<String>):Void{
		...
		switch(combo){
			...
			case "KADE":
				Config.write(offsetValue, "complex", false, 5, 5, iconValue, downValue, false, 2, noCapValue, scheme);
				exit();
			case "ROZE":
				Config.write(offsetValue, "simple", false, 1, 1, true, true, true, 0, noCapValue, scheme);
				exit();
			case "CVAL":
				Config.write(offsetValue, "simple", false, 1, 1, iconValue, false, glowValue, 1, noCapValue, scheme);
				exit();
